...
$queryStarter = $pdo->query("SELECT * FROM indianmenu WHERE category = 'Starter'");
$starterItems = $queryStarter->fetchAll(PDO::FETCH_ASSOC);

// Fetch menu items for Main
$queryMain = $pdo->query("SELECT * FROM indianmenu WHERE category = 'Main'");
$mainItems = $queryMain->fetchAll(PDO::FETCH_ASSOC);

// Fetch menu items for Drinks
$queryDrinks = $pdo->query("SELECT * FROM indianmenu WHERE category = 'Drinks'");
